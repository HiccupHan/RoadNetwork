...
int RoadNetwork::addRoadSegmentStartEnd(const string& name, const string& start_road_segment, bool start_is_end, const string& end_road_segment, bool end_is_end, const int dist, const int num_lanes) {
...
int RoadNetwork::addRoadSegmentNoStart(const string &name, const string &end_road_segment, bool is_end, int dist, int num_lanes) {
...
int RoadNetwork::addRoadSegmentNoEnd(const string &name, const string &start_road_segment, bool is_end, int dist, int num_lanes) {
...
int RoadNetwork::addRoadSegment(const string &name, const int dist, const int num_lanes) {
